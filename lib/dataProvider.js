                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            dbConnection = _mysql2.default.createConnection({
                            ...
                            _context.next = 5;
                            return regeneratorRuntime.awrap(_publicTransportDatabase2.default.useConnection(dbConnection));
